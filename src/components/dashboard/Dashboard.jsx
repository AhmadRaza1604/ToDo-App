  ...
  return (
    <div>
      ...
      <div id='dash-res' className=" w-full border-gray rounded-sm mt-4 border h-full flex justify-between">
        <div  id='dash-res1' className='w-3/6 border-gray-100 rounded-xl shadow-lg justify-self-center border h-full m-4 max-lg:my-4'>
        ...
        <div id='dash-res1' className='w-3/6 m-4  justify-self-center'>

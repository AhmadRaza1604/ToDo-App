...
const VitalTask = () => {
    ...
    return (
        ...
        <div id='dash-res1' className='w-3/6 border-gray-100 rounded-xl shadow-lg my-4 justify-self-center border h-full'>
        <div id='header-1' className='mt-2'>
                <h1 id='account-header' className="text-start font-semibold font-sans text-teal-700 text-lg border-b-2 mt-2 w-fit border-teal-700">Vital Tasks</h1>
            </div>
          {taskData.map((data, index) => (
            ...
            <div id='dash-res1' className='w-3/6 my-4 justify-self-center border-gray-100 rounded-xl shadow-lg border h-fit'>

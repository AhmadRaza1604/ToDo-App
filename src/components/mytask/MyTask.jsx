...
const MyTask = () => {
    ...
    return (
        ...
        <div  id='dash-res1' className='border-gray-100 rounded-xl shadow-lg m-4 border h-full'>
        <div id='header-1' className='mt-2'>
          ...
          {taskData.map((data, index) => (
            ...
            <div id='dash-res1' className=' m-4 border-gray-100 rounded-xl shadow-lg border h-fit'>
